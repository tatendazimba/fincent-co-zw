<template>
    <div style="overflow: visible;">
        ...
        <div class="hoverable" style="">
            <div class="no-margin valign-wrapper" style="background: linear-gradient(rgba(42, 35, 76, .5), rgba(42, 35, 76, .5)), url('/images/city/nelson.jpg') no-repeat center center; background-size: cover; height: 900px;">
